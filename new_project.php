...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
          	...
          	<div class="col-md-6">
				<div class="form-group">
					...
					<select name="status" id="status" class="custom-select custom-select-sm">
						<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Ожидает</option>
						<option value="3" <?php echo isset($status) && $status == 3 ? 'selected' : '' ?>>Пауза</option>
						<option value="5" <?php echo isset($status) && $status == 5 ? 'selected' : '' ?>>Завершен</option>
					</select>
				</div>
			</div>
		</div>
		<div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Дедлайн</label>
        ...
        <div class="row">
           ...
           <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Руководитель проекта</label>
      ...
      <?php endif; ?>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Участники проекта</label>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			...
    			<button class="btn btn-flat bg-gradient-secondary mx-2" type="button" onclick="location.href='index.php?page=project_list'">Отмена</button>
    		</div>
    	</div>
	</div>
</div>
