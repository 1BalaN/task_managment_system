...
<?php
if(isset($_GET['id'])){
	$type_arr = array('',"Администратор","Руководитель проекта","Сотрудник");
...
<div class="container-fluid">
	<div class="card card-widget widget-user shadow">
      ...
      <div class="widget-user-image">
      	...
      	<?php else: ?>
        <img class="img-circle elevation-2" src="assets/uploads/<?php echo $avatar ?>" alt="Аватар пользователя"  style="width: 90px;height:90px;object-fit: cover">
      	<?php endif ?>
      </div>
